...
Release 1.0.0 supports the universal Android package:
...
runtime includes mission gameplay and the native focus-loss/pause exit flow.

### Architecture and native flow

`Dead Trigger.sh` is a self-contained nxbootstrap 0.6 launcher. It prepares
...
AArch64 seguindo o fluxo Android/Unity real. A release 1.0.0 foi validada no
...
gameplay de missão e saída pelo fluxo nativo de perda de foco/pause.

### Framework, dados e controles

`Dead Trigger.sh` é o launcher autossuficiente do nxbootstrap 0.6. Ele roda o

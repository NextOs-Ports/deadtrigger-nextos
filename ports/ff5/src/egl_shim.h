/*
 * egl_shim.h -- EGL wrapper backed by SDL2 (OpenGL ES 2.0, Mali-450 fbdev)
 */
...
// Query the resolved window size (0 until egl_shim_create_window runs)
int egl_shim_width(void);
int egl_shim_height(void);
